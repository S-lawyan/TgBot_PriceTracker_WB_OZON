...
class Selen:
    ...
    def close_drivers(self, source: str):
        DRIVER: webdriver.Chrome = self.drivers_list.get(source)
        # Закрывает определенный драйвер
        DRIVER.close()
        ...
        for i in range(3):
            ...
            try:
                ...
                try:
                    ...
                    logging.error(f"OZON: Исключение при получении цены: {e} --- {url}")
                    continue
